...
exp_root_dir = os.path.join(root_path, 'experiments', 'PRETRAINED')
...
cudnn_benchmark = True if gpu_condition else False  # This flag allows us to enable the inbuilt CuDNN auto-tuner to
...
sampling_type = 'random'  # ['random', 'stratified']. Method for dataset splitting.
...
clinical_variables_dropout_p = [0]
...
optimizer_name = 'ada_bound'  # ['adam', 'adam_w', 'rmsprop', 'sgd', 'sgd_w', 'acc_sgd', 'ada_belief', 'ada_bound',
...
scheduler_name = None  # [None, 'cosine', 'cyclic', 'exponential', 'step', 'lr_finder', 'reduce_lr', 'batch_size',
...
gamma = 0.98  # (ExponentialLR, StepLR) Multiplicative factor of learning rate decay every epoch (ExponentialLR) or
# step_size (StepLR).
